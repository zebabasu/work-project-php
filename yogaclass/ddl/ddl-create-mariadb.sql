CREATE TABLE YOGA_CLASS (ID BIGINT NOT NULL AUTO_INCREMENT, CLASSNAME VARCHAR(25), LASTUPDATED TIMESTAMP, PUBLICSHARED BIGINT, YOGATEACHER_NAME VARCHAR(25), YOGATEACHER_EMAIL_ID VARCHAR(25), CONSTRAINT classid_pk PRIMARY KEY (ID));
