CREATE TABLE YOGA_CLASS (ID BIGINT NOT NULL, CLASSNAME VARCHAR(25), LASTUPDATED TIMESTAMP, PUBLICSHARED BIGINT, YOGATEACHER_NAME VARCHAR(25), YOGATEACHER_EMAIL_ID VARCHAR(25), CONSTRAINT classid_pk PRIMARY KEY (ID));
...
-- insert default data
INSERT IGNORE INTO YOGA_TEACHER(TEACHERNAME, LASTUPDATED) VALUES('Default Yoga Teacher', NOW());